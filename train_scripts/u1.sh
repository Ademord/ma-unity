...
#     inf_o.run63++025 inf_o.run63++025 5005 && \


# cd ~/ultron/configLoader_v4/scripts && ./inference_octree_resume.sh \
#     inf_o.run63++100-nospeed-nolinger inf_o.run63++100-nospeed-nolinger 5005 && \
...
# cd ~/ultron/configLoader_v4/scripts && ./inference_octree_resume.sh \
#    inf_o.run61-explore-constrained-nospeed inf_o.run61-explore-constrained-nospeed 5005 # run61-explore-constrained-nospeed


    
# cd ~/ultron/configLoader_v4/scripts     && \
#     ./train_visON.sh run68 5005
# cd ~/ultron/configLoader_v4/scripts     && \
