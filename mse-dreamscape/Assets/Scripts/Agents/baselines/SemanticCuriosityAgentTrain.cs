...
namespace Ademord
{
    ...
    public class SemanticCuriosityAgentTrain : DetectorAgentTrain
    {
        ...
        [SerializeField] private bool m_SemanticCuriosityObservations = true;
        [SerializeField] private bool m_TrainSemanticCuriosity = true;
        ...
        public override void AddTensorboardStats()
        {
            ...
            m_TBStats.Add(m_BehaviorName + "/SumOfElementsInSemanticMap ", m_SumOfElementsInSemanticMap);
        }
