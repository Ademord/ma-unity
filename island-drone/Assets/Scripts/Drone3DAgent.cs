...
{
    /// <summary>
    /// Agent that pilots a <see cref="Drone>"/> and has to 
    /// discover <see cref="Voxel"/>s in a 3D scene.
    /// </summary>
    public class Drone3DAgent : Agent
    {
        ...
        // game rules
        [Header("Collectible Parameters")] private GameObject lastHit;
        ...
        [Header("Cone Scanner Parameters")] public float radius;
        public float depth;
        public float angle;
        ...
        public bool CanBeCollected
        {
            get
            {
                return dotProductToTarget < REWARD_DOT_PRODUCT_TO_TARGET &&
        ...
        void Update()
        {
            ...
            if (coneHits.Length > 0)
            {
                ...
                for (int i = 0; i < coneHits.Length; i++)
                {
                    ...
                    {
                        print("conecast could not detect a voxel in detected collider named: " + coneHits[i].transform.name);
                    }
                }
            }
            else
