...
namespace Ademord
{
    public class VoxelAgentTrain : VoxelAgent
    {
        ...
        protected virtual void DrawGUIStats()
        {
            ...
            // m_GUIStats.Add(m_Drone.AvgSpeed, "Speed", "Measured Avg.", Colors.Lightblue);
            //
            // m_GUIStats.Add(m_Drone.TargetHeight, "Height", "Target", Colors.Orange);
            // m_GUIStats.Add(m_Drone.AvgHeight, "Height", "Measured Avg.", Colors.Lightblue);
            //
            ...
            var palette = Colors.Palette(2, 1, 0.5f, 0.2f, 0.8f);

            float sum =
                m_GUIStats.Add(GetVoxelDiscoveryReward(), "Rewards", "Voxel", palette[0]) +
        ...
        {
            return (float) m_VoxelsScanned / (2 + m_VoxelsScanned) * 1f;
        }
