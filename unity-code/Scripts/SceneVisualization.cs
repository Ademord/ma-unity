...
namespace Ademord
{
    ...
    {
        [SerializeField] [BitMask(typeof(DrawFilter))]
        private DrawFilter drawFilter;

        [SerializeField] private PointType pointFilter;
        [SerializeField] [Range(2f, 200f)] private float drawRadius = 8f;
        ...
        private void OnEnable()
        {
            ...
            {
                return cam.name == "OverviewCamera";
            };
            Gizmos.CameraFilter += cam =>
            {
                return cam.name == "OverviewCamera_TOP";
            };
        }
        ...
        private void OnValidate()
        {
            if (isReady)
            {
                ...
                // TODO make it possible to disable the world
