...
namespace Ademord
{
    public class Body : MonoBehaviour
    {
        ...
        [SerializeField] private int m_BufferSize = 300;
        ...
        [Space] [SerializeField] private float m_ControlIncrement = 0.025f;
        [SerializeField] private float m_ControlAttenuate = 0.95f;
        [SerializeField] private float m_BackwardSpeedFactor = 0.25f;
        ...
        private float MAXALLOWEDSECONDSINCOLLISION = 2;
        private float MaxAllowedSecondsInCollisionCounter;
        ...
        public void ManagedReset(bool randomizeRotation = false, Vector3 position = default)
        {
            ...
            MaxAllowedSecondsInCollisionCounter = MAXALLOWEDSECONDSINCOLLISION;
        ...
        public float ControlWithThrottle(float throttle_horizontal, float throttle_sideways, float throttle_vertical,
            float yaw)
        {
       ...
       void Update()
        {
            ...
            {
                MaxAllowedSecondsInCollisionCounter -= Time.deltaTime;
            }

            if (MaxAllowedSecondsInCollisionCounter <= 0)
            {
                AddRandomForce(1000);
                ResetTimer();
            }
