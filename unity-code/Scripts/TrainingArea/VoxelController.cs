...
namespace Ademord
{
    public class VoxelController : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            m_Collider = transform.GetComponentInChildren<Collider>()?.transform;

            if (_voxelMeshRenderer == null)
            {
                print("ERROR: _voxelMeshRenderer was NOT FOUND");
            }
            // else print("VoxelController: _voxelMeshRenderer was FOUND.");
            if (m_Collider == null)
            {
                if (m_Collider == null) print("ERROR: collider in voxel was NOT FOUND");
            }
            // else print("VoxelController: m_Collider was FOUND.");
        }
